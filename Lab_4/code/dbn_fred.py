    ...
    def train_wakesleep_finetune(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try:
            ...
            for it in range(n_iterations):
                ...
                prob_wk_pen, activwk_pen = self.rbm_stack['hid--pen'].get_h_given_v_dir(prob_wk_hid)
                ...
                # for _ in range(self.n_gibbs_gener):
                for _ in range(2):
                    layer_with_labels = np.hstack((activ_wk_pen, lbl_trainset))
                    hidden_layer = self.rbm_stack['pen+lbl--top'].get_h_given_v(layer_with_labels)[1]
                ...
                #activations_h = self.rbm_stack['hid--pen'].get_h_given_v_dir(activations_h)[1]
                activations_h = self.rbm_stack['hid--pen'].get_v_given_h_dir(activations_h)[1]
                ...
                self.rbm_stack['pen+lbl--top'].cd1(visible_trainset=lbl_trainset, n_iterations=15) #10 to 20 iterations
                ...
                #self.rbm_stack['hid--pen'].cd1(visible_trainset=vis_trainset, n_iterations=15) #10 to 20 iterations
                self.rbm_stack['hid--pen'].update_recognize_params(vis_trainset, lbl_trainset, preds)
                
                #self.rbm_stack['vis--hid'].cd1(visible_trainset=vis_trainset, n_iterations=15) #10 to 20 iterations
