...
class DeepBeliefNet:
    ...
    def recognize(self,true_img,true_lbl):
        ...
        prob = self.rbm_stack['hid--pen'].get_h_given_v_dir(prob)[0]  # normal 1
        ...
        for _ in range(self.n_gibbs_recog):
            hidden_layer = self.rbm_stack['pen+lbl--top'].get_h_given_v(start_input)[0]  # normal 1
            start_input = self.rbm_stack['pen+lbl--top'].get_v_given_h(hidden_layer)[0]  # normal 1
    ...
    def generate(self, true_lbl, name):
        ...
        for _ in range(self.n_gibbs_gener):
            for k in range(1):
                ...
                hidden_layer = self.rbm_stack['pen+lbl--top'].get_h_given_v(layer_with_labels)[0] # normal 1
                top_hidden_layer = self.rbm_stack['pen+lbl--top'].get_v_given_h(hidden_layer)[0][:, :-lbl.shape[1]]#normal 1
    ...
    def train_greedylayerwise(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try:
            ...
            self.rbm_stack['hid--pen'].cd1(prob, n_iterations=n_iterations) # normal activations_h
            ...
            full_activations = np.hstack((prob, lbl_trainset)) # normal activations_h
